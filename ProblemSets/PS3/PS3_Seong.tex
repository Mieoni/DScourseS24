...
\noindent \text{\Large{Question 1. How big was the insuracne .csv file (once uncompressed?}}\\
\indent The size of the file is 5MB.
\\
\\

\noindent \text{\Large{Question 2. How many lines did the CSV file have before doing the end-of-line (EOL) oncersion?}}\\
\indent The number of lines that the CSV file have before doing the end-of-line (EOL) conversion is 0.  
\\
\\

\noindent \text{\Large{Question 3. How many lines did the CSV file have after doing the end-of-line (EOL) conversion? }}\\
\indent The number of lines that the CSV file have after doing the end-of-line (EOL) conversion is 36634.
