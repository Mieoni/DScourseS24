...
\noindent \text{\Large{Question : Data Sources that I would like to scrap}}\\
\\
\noindent \text{\Large{I am interested in scraping from South Korea stock market data.}}\\
\\
\\
\\

\noindent \text{\Large{Question : what type of an object is mydf\$date?}}\\
\\
\noindent \text{\Large{The answer is Character.}}\\
